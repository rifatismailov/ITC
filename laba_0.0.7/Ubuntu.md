...
> Не закривайте поточний термінал! Відкрийте новий для тесту.
...
> Виконувати на вашому комп'ютері, НЕ на сервері!
...
> Виконуйте з ІНШОГО ПК або терміналу — інакше заблокуєте себе!
